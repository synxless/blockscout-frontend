...
const ChartArea = ({ id, xScale, yScale, color, data, disableAnimation, ...props }: Props) => {
  ...
  const defaultGradient = {
    startColor: useToken('colors', useColorModeValue('yellow.100', 'yellow.400')),
    stopColor: useToken('colors', transparentize(useColorModeValue('yellow.100', 'yellow.400'), 0)(theme)),
  };
