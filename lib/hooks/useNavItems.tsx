            ...
            [
              {
                ...
                nextRoute:
                  {
                    pathname:
                      "/contract-verification" as const,
                  },
                isActive:
                  pathname.startsWith(
      ...
      [
        ...
        },
        {
          ...
          nextRoute:
            {
              pathname:
                "/account/public-tags-request" as const,
            },
          icon: "publictags",
          isActive:
            pathname ===
        ...
        config
          ...
          nextRoute:
            {
              pathname:
                "/account/verified-addresses" as const,
            },
          icon: "verified",
          isActive:
            pathname ===
